...
unsigned short int address(char *str, char skip)
{
  unsigned short int valor;
  sscanf(str + skip, "%hx", &valor);
  printf("%d\n", valor);
  return valor;
}
...
int main()
{
  ...
  char raw[mem] = {};
  unsigned short int final[mem] = {0x4E03, 0x5244};
